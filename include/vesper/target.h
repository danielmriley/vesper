...
// is 64 B halves; Q8 qs is 64 B pairs. Same bytes as GGUF on official
// Q4 and Q8 shapes and on Q6 o_proj (24 supers). Official Q6 lm_head
// pads d by 8 B/row. Cached headers stay off the NT qs stream.
